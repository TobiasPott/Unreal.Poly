...
public: 
	static void AddMeshElementsTransform(UDynamicMesh* TargetMesh, FGeometryScriptMeshSelection Selection, bool bUseOrigin, FVector Origin, FTransform InTransform, ETransformSpace Space = ETransformSpace::TS_World);
